...
fn test_sync_agent_docs_check_fails_before_sync() {
	...
	script := os.real_path('cmd/tools/agents/sync_agent_docs.vsh')
...
fn test_sync_agent_docs_rewrites_from_template_to_golden() {
	...
	expected := os.read_file('cmd/tools/agents/testdata/sync_agent_docs_llms.golden') or {
		panic(err)
	}
	assert got == expected
...
fn prepare_sync_fixture() !string {
	...
	llms := os.read_file('cmd/tools/agents/testdata/sync_agent_docs_llms.input')!
	workflow := os.read_file('cmd/tools/agents/testdata/sync_agent_docs_workflow.input')!
	playbook := os.read_file('cmd/tools/agents/testdata/sync_agent_docs_playbook.input')!
